  ...
  head () {
    return {
      meta: [
        ...
        { hid: 'og:description', property: 'og:description', content: 'Freelance web developer based in Manchester. Experienced with building bespoke user interfaces, websites and web applications.' },
        { hid: 'og:url', property: 'og:url', content: process.env.NUXT_HOST + this.$route.path },
        { hid: 'og:image', property: 'og:image', content: process.env.NUXT_HOST + '/og-image.png' },
        {
          hid: 'og:image:secure_url',
          property: 'og:image:secure_url',
          content: process.env.NUXT_HOST + '/og-image.png'
        },
        { hid: 'og:type', property: 'og:type', content: 'website' },
        { hid: 'twitter:card', name: 'twitter:card', property: 'twitter:card', content: process.env.NUXT_HOST + '/og-image.png' }
      ],
      link: [
        {
          rel: 'canonical',
